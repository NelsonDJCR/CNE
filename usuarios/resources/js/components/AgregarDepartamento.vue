            ...
            <template v-if="listado==1">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Agregar Departamento
                        <template>
            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <form class="forms-sample">
                        <div class="form-group">
                            <label>Nombre</label>
                            <input type="text" v-model="nombre" class="form-control" placeholder="Nombre departamento">
                        </div>
                        <div class="form-group">
                    ...
                    case "departamento":
                        {
                            ...
                            case 'create':
                                {   
                                this.tituloFormulario = "Registrar Departamento";
                                this.nombre = '';
                                this.imagen = '';
                                this.nombre_db = '';
                                this.url_produccion = '';
                            ...
                            case 'update':
                            {
                                this.tituloFormulario = "Actualizar el Departamento";
